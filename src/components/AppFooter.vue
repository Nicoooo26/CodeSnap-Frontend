...
<template>
  <footer class="bg-stone-500 dark:bg-stone-800 border-t border-stone-700 dark:border-white">
    <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-6">
      <div class="sm:flex sm:items-center sm:justify-between">
        ...
        <div class="flex mt-4 sm:justify-center sm:mt-0">
          <a href="#" class="text-stone-700 hover:text-stone-900 dark:hover:text-white">
            <svg class="w-4 h-4" aria-hidden="true" fill="currentColor" viewBox="0 0 8 19">
              <path fill-rule="evenodd" d="M6.135 3H8V0H6.135a4.147 4.147 0 0 0-4.142 4.142V6H0v3h2v9.938h3V9h2.021l.592-3H5V3.591A.6.6 0 0 1 5.592 3h.543Z" clip-rule="evenodd" />
            </svg>
          </a>
          <a href="#" class="text-stone-700 hover:text-stone-900 dark:hover:text-white ms-5">
