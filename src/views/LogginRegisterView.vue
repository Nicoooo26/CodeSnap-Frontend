  ...
  <div id="app" class="flex h-screen">
    <div v-if="showPopup" id="toast-success"
      ...
      <button type="button"
        ...
        data-dismiss-target="#toast-success" aria-label="Close" @click="closePopup">
    ...
    <div
      class="w-1/2 flex flex-col justify-center px-8 bg-gray-50 text-white dark:bg-gray-800 border-r-2 dark:border-white border-black">
      <div class="flex flex-col items-center mb-8">
        ...
        <p class="text-lg text-center text-gray-900 dark:text-white">Descubre una plataforma para desarrolladores donde
          puedes compartir tus ideas, código y experiencias de manera fácil y rápida.</p>
      </div>
    </div>
    ...
    <div class="w-1/2 flex justify-center items-center bg-gray-50 dark:bg-gray-800">
      <div class="max-w-md w-full">
        ...
        <button @click="toggleDark()"
          class=" absolute top-4 right-4 bg-white border border-gray-500 dark:border-gray-500 dark:bg-gray-800 rounded-full px-3 py-2">
          <span class=" text-white pi pi-moon " v-if="isDark"></span>
          <span class="text-dark pi pi-sun" v-else></span>
        </button>

        <form id="login-form" class="bg-white dark:bg-gray-700 shadow-md rounded px-8 pt-6 pb-8 mb-4"
          :class="{ hidden: !loginVisible }" @submit.prevent="login">
          <div class="mb-4">
            <label>
              <span
                class="after:content-['*'] after:ml-0.5 after:text-red-500 block text-black dark:text-white text-sm font-bold mb-2">Username</span>
              <input type="text"
                class="dark:bg-gray-600 dark:text-white shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline"
          ...
          <div class="mb-6">
            <label>
              <span
                class="after:content-['*'] after:ml-0.5 after:text-red-500 block text-black dark:text-white text-sm font-bold mb-2">Contraseña</span>
              <input type="password"
                class="dark:bg-gray-600 dark:text-white shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline"
                id="password" v-model="passwordLogin" placeholder="Password" />
          ...
          <div class="flex items-center justify-between">
            <button type="submit"
              class="bg-gray-500 hover:bg-gray-800 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">Iniciar
              Sesión</button>
          </div>
        </form>

        <form id="register-form" class="bg-white dark:bg-gray-700 shadow-md rounded px-8 pt-6 pb-8 mb-4"
          :class="{ hidden: loginVisible }" @submit.prevent="register">
          <div class="mb-2">
            <label>
              <span
                class="after:content-['*'] after:ml-0.5 after:text-red-500 block text-gray-700 dark:text-white text-sm font-bold mb-2">Username</span>
              <input type="text"
                class="dark:bg-gray-600 dark:text-white shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline"
          ...
          <div class="mb-4">
            <label>
              <span
                class="after:content-['*'] after:ml-0.5 after:text-red-500 block text-gray-700 dark:text-white text-sm font-bold mb-2">Email</span>
              <input type="email"
                class="dark:bg-gray-600 dark:text-white shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline"
          ...
          <div class="mb-24">
            <label>
              <span
                class="after:content-['*'] after:ml-0.5 after:text-red-500 block text-gray-700 dark:text-white text-sm font-bold mb-2">Contraseña</span>
        ...
        <div class="flex items-center justify-center mt-6">
          <button id="toggle-form" class="text-sm dark:text-white text-black hover:underline focus:outline-none"
